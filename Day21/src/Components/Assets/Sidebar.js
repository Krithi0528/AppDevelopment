      ...
      <div className='full22'> 
           <div class="navbar">
              <div class="menu">
               <ul>
                  ...
                  <li><Link to="/footer"><span className='icon'><AiIcons.AiOutlineHome/></span>&nbsp;&nbsp;HOME</Link></li>
                  <li><Link to="/weather"><span className='icon'><TiIcons.TiWeatherPartlySunny/></span>MyWeather</Link></li>
                  <li><Link to="/history"><span className='icon'><IoIcons.IoInformationCircleSharp/></span>History</Link></li>
          ...
          <div className="sidebar">
            ...
            <ul>
              ...
              <li><Link to="/"><span className='icon'><IoIcons.IoInformationCircleSharp/></span>LogOut</Link></li>
